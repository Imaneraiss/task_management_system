...
<body>
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title-2">
				<a href="create_task.php" class="btn " style="color: black;">Create Task</a>
				<a href="tasks.php?due_date=Due Today" class="btn" style="color: black;">Due Today</a>
				<a href="tasks.php?due_date=Overdue" class="btn" style="color: black;">Overdue</a>
				<a href="tasks.php?due_date=No Deadline" class="btn" style="color: black;">No Deadline</a>
				<a href="tasks.php" class="btn" style="color: black;">All Tasks</a>
